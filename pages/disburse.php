...
<head>
  ...
  <script type="text/javascript">
    ...
    function getDepartment_sub() {
      ...
      // alert(DepCode);
      var data = {
        'STATUS': 'getDepartment_sub',
        'Hotp': Hotp,
        'DepCode': DepCode
      };
      senddata(JSON.stringify(data));
    }
    function getDepartment_sub2() {
      var Hotp = $('#hotpital option:selected').attr("value");
      var DepCode = $('#dis_department option:selected').attr("value");
      if (typeof Hotp == 'undefined') Hotp = "1";
      if (typeof DepCode == 'undefined') DepCode = "1";
      // alert(Hotp);
      // alert(DepCode);
    ...
    function ShowDocument(selecta) {
      ...
      var DebCode = $('#department').val();
      var DepSubCode = $('#department_sub').val();
      //   alert(DepSubCode);
    ...
    function CreateDocument() {
      var iqty = $('#iqty_dis0').val();
      var DocNox = $('#docno').val();
      // var add = parseInt($('#iqty_dis' + Id).val());
      var deptCodex = $('#DepCode_x').data('value');
      var DepSubCodex = $('#DepSubCode_x').data('value');

      var ItemCodex = $('#item_x').data('value');
      var userid = '<?php echo $Userid; ?>';
      var hotpCode = $('#hotpital option:selected').attr("value");
      var DepCodeFrom = $('#dis_department option:selected').attr("value");
      var DepSubCodeFrom = $('#department_sub option:selected').attr("value");
      // alert(ItemCodex);
      // alert(DocNox);
      // alert(deptCodex);
      // alert(DepSubCodex);
      ...
      swal({
        ...
        text: 
          ...
          " <?php echo $array['department_sub'][$language]; ?> : " + $('#department_sub option:selected').text(),
    ...
    function addnum1(Id) {
      var rowid = $('#iqty_dis' + Id).val();
      var qtyMax = $('#iqty_dis' + Id).data('value');
      var add = parseInt($('#iqty_dis' + Id).val()) + 1;
      if  (add > qtyMax) {
        $('#iqty_dis' + Id).val(qtyMax);
      }else{
        $('#iqty_dis' + Id).val(add);
      }
    }
    ...
    function subtractnum1(Id) {
      var rowid = $('#iqty_dis' + Id).val();
      var sub = parseInt($('#iqty_dis' + Id).val()) - 1;
      if (sub <= 0) {
        $('#iqty_dis' + Id).val(1);
      }else{
        $('#iqty_dis' + Id).val(sub);
    ...
    <!-- ======================JAPCreate===================== -->
    function ShowDetail_InStock(){
      var hos = $('#hotpital').val();
      var dept = $('#department').val();
      var search = $('#searchtxt').val();
      if( typeof deptCode == 'undefined' ) deptCode = "1";
      var data = {
        'STATUS'  	: 'ShowDetail_InStock',
        'chk'  	: 0,
      };
      // console.log(JSON.stringify(data));
      senddata(JSON.stringify(data));
    ...
    function show_li(rowID){
      var row = rowID.split(",");
      $('#show_li'+row[0]).attr('hidden', true);
      $('#hide_li'+row[0]).removeAttr('hidden');
      $('#li_show'+row[0]).removeAttr('hidden');
      $('#li_qty'+row[0]).removeAttr('hidden');
      $('#disburse_'+row[0]).removeAttr('hidden');
    }
    function hide_li(rowID){
      ...
      $('#disburse_'+row).attr('hidden', true);
      $('#show_li'+row).removeAttr('hidden');
    }
    function search_stock(chk){
      var hos = $('#hotpital').val();
      var dept = $('#department').val();
      // var chk = chk;
      var data = {
    ...
    function disburse_modal(rowId) {
      var SubRow = rowId.split(",");
      var HptCode = $('#hotpital option:selected').attr("value");
      var DepCode = $('#department option:selected').attr("value");
      var DepSubCode = $('#DepSubCode_'+SubRow[1]).data('value');
      var ItemCode = $('#item_'+SubRow[0]).data('value');
      var Qty = $('#Qty_'+SubRow[0]+SubRow[1]).data('value');

      var data = {
        'STATUS': 'Select_FromStock',
        'HptCode': HptCode,
        'DepCode': DepCode,
        'DepSubCode': DepSubCode,
        'ItemCode': ItemCode,
    ...
    function ShowDocument_dis(selecta) {
      var searchdocument = $('#searchdocument').val();
      if (typeof searchdocument == 'undefined') searchdocument = "";
      var DepCode_dis = $('#Dep2 option:selected').attr("value");
          ...
          if (temp["status"] == 'success') {
            if (temp["form"] == 'OnLoadPage') {
              ...
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                ...
                $("#dis_department").append(Str);
                $("#Dep2").append(Str);
              }
            } else if (temp["form"] == 'getDepartment_sub') {
              $("#department_sub").empty();
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                var Str = "<option value=" + temp[i]['DepSubCode'] + ">" + temp[i]['DepSubName'] + "</option>";
                $("#department_sub").append(Str);
              }
              ...
              for (var i = 0; i < temp["Row"]; i++) {
                ...
                var Qty = "<div class='row' style='margin-left:5px;'><button class='btn btn-danger' style='height:40px;width:32px;' onclick='subtractnum1(\"" + i +"\")'>-</button><input class='form-control' style='height:40px;width:60px; margin-left:3px; margin-right:3px; text-align:center;' " + st2 + 
                " id='qty1_" + i + "' value='" + temp[i]['Qty'] +"' onKeyPress='if(event.keyCode==13){SaveQtyTime(" + i + ")}'><button class='btn btn-success' style='height:40px;width:32px;' onclick='addnum1(\"" + i +"\")'>+</button></div>";
              ...
              for (var i = 0; i < temp["Row"]; i++) {
                ...
                var Qty = "<div class='row' style='margin-left:5px;'><button class='btn btn-danger' style='height:40px;width:32px;' onclick='subtractnum(\"" + "' value='1' ><button class='btn btn-success' style='height:40px;width:32px;' onclick='addnum(\"" + i + "\")'>+</button></div>";

                var Weight =  "<div class='row' style='margin-left:2px;'><input class='form-control' style='height:40px;width:134px; margin-left:3px; margin-right:3px; text-align:center;' id='iweight" +
                  i + "' value='0' ></div>";
            ...
            } else if(temp["form"]=='ShowDetail_InStock'){
              $( "#TableDocument tbody" ).empty();
              ...
              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                ...
                var disburse = "<ol id='disburse_"+i+"' hidden style='list-style-type:none;'>";
                for(var j = 0; j < temp['Cnt_' + temp[i]['ItemCode']][i]; j++){
                    var btn_li = "<a href='javascript:void(0)' id='show_li"+i+"'><h3><span class='badge badge-info' onclick='show_li(\""+i+","+j+"\")'>แสดง</span></h3></a>";
                    depSub+="<li id='DepSubCode_"+j+"' data-value='"+temp['DepSubCode_' + temp[i]['ItemCode'] + '_' + i][j]+"'>"+temp['DepSubName_' + temp[i]['ItemCode'] + '_' + i][j] +"</li>";
                    if(temp['Qty_' + temp[i]['ItemCode'] + '_' + i][j]==null || temp['Qty_' + temp[i]['ItemCode'] + '_' + i][j]==undefined || temp['Qty_' + temp[i]['ItemCode'] + '_' + i][j] == '' || temp['Qty_' + temp[i]['ItemCode'] + '_' + i][j] == 0){
                      Qty+="<li>0</li>";
                      disburse+="<li><label class='text-secondary'>-</label</li>";
                    }else{
                      Qty+="<li id='Qty_"+i+j+"' data-value='"+temp['Qty_' + temp[i]['ItemCode'] + '_' + i][j] +"'>"+temp['Qty_' + temp[i]['ItemCode'] + '_' + i][j] +"</li>";
                      disburse +="<li><a href='javascript:void(0)'><h3><span class='badge badge-success' onclick='disburse_modal(\""+i+","+j+"\")'>ขอเบิก</span></h3></a></li>";
                    }
                ...
                "<td style='width: 10%;' data-value='"+temp[i]['ItemCode']+"' id='item_"+i+"'>"+temp[i]['ItemCode']+"</td>"+
                "<td style='width: 12%;'>"+temp[i]['ItemName']+"</td>"+
                "<td style='width: 15%;'>"+temp[i]['CategoryName']+"</td>"+
                "<td style='width: 12%;'><center>"+temp[i]['DepName']+"</center></td>"+
                "<td style='width: 12%;'><center>"+temp[i]['total']+"</center></td>"+
                "<td style='width: 13%;'><center>"+btn_li+depSub+"</center><div id='hide_li"+i+"' hidden class='text-center'>"+btn_hide+"</div></td>"+
                "<td style='width: 10%;padding-left: 64px;' class='text-right'><center>"+Qty+"</center></td>"+
                "<td style='width: 11%;padding-left:48px;'><center>"+disburse+"</center></td>"+
                "</tr>";
                if(rowCount == 0){
                  $("#TableDocument tbody").append( StrTr );
                }else{
            ...
            } else if(temp["form"]=='Select_FromStock'){
              
              $('#docdate').val('');
              $('#docno').val('');
              $('#disburseModal').modal("show");
              $('#docdate').val(temp['DocDate']);
              $('#docno').val(temp['DocNo']);

              $("#table_disburse tbody").empty();
              $("#table_disburse tbody").empty();
              
              
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                var Qty = "<div class='row' style='margin-left:54px;'><button class='btn btn-danger'  style='height:40px;width:32px;' onclick='subtractnum1(\"" + i +"\")'>-</button><input type='number' class='form-control text-center' style='width:155px;font-size:25px;margin:2px;' id='iqty_dis"+i+"' value='1' min='1' data-value='"+temp['Qty']+"' max='"+temp['Qty']+"' onkeyup='if(this.value > "+temp['Qty']+"){this.value="+temp['Qty']+"}else if(this.value<=0){this.value=1}'><button class='btn btn-success' style='height:40px;width:32px;' onclick='addnum1(\"" + i +"\")'>+</button></div>";
                var rowCount = $('#table_disburse >tbody >tr').length;
                ...
                StrTr = "<tr id='tr" + temp[i]['ItemCode'] + "'>" +
                  ...
                  "<td style='width: 20%;'>" + temp[i]['DepName'] + "</td>" +
                  "<td style='width: 18%;'>" + temp[i]['DepSubName'] + "</td>" +
                  "<td style='width: 12%;text-align: center;'>" + temp['Qty'] + "</td>" +
                  "<td style='width: 12%;' hidden data-value='" + temp[i]['DocNo'] + "' id='DocNo_x'>" + temp['DocNo'] + "</td>" +
                  "<td style='width: 12%;' hidden data-value='" + temp[i]['DepSubCode'] + "' id='DepSubCode_x'>" + temp[i]['DepSubCode'] + "</td>" +
                  "<td style='width: 12%;' hidden data-value='" + temp[i]['DepCode'] + "' id='DepCode_x'>" + temp[i]['DepCode'] + "</td>" +
                  "<td style='width: 24%;text-align:center;'>"+Qty+"</td>" +
                  "</tr>";
     
                if (rowCount == 0) {
                  $("#table_disburse tbody").append(StrTr);
                } else {
                  $('#table_disburse tbody:last-child').append(StrTr);
                }
              }
              ...
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                ...
                var Style = "";
                if (temp[i]['IsStatus'] == 1) {
                  Status = "<?php echo $array['yesconfirm'][$language]; ?>";
                  Style = "style='width: 10%;color: #20B80E;'";
                } else {
              ...
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                ...
                StrTr = "<tr id='tr" + temp[i]['ItemCode'] + "'>" +
                  ...
                  "<td style='width: 20%;'>" + temp[i]['DepName'] + "</td>" +
                  "<td style='width: 18%;'>" + temp[i]['DepSubName'] + "</td>" +
                  "<td style='width: 20%;text-align: right;'>" + temp[i]['Qty'] + "</td>" +
                  "</tr>";
          ...
          <div class="container-fluid">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
                  aria-selected="true"><?php echo $array['stock'][$language]; ?></a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="container-fluid">
                      <div class="card-body" style="padding:0px; margin-top:10px;">
                        <div class="row">
                          ...
                          <div style="margin-left:30px;width:90px;text-align: right;padding-right: 20px;">
                            <label><?php echo $array['department'][$language]; ?></label>
                          </div>
                          <div style="width:220px;">
                            <div class="row" style="font-size:24px;margin-left:2px;">
                              <select style='font-size:24px;width:220px;' class="form-control" id="department" onchange="getDepartment_sub();">
                          ...
                          <div style="width:220px;">
                            <div class="row" style="font-size:24px;margin-left:20px;">
                              <button onclick="search_stock(1);" style="width:95px;height: 42px;" class="btn btn-info btn-xs" id="search_stock"><?php echo $array['search'][$language]; ?></button>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-12" style=' padding-left:0px !important;padding-right:21px !important;'>
                    <!-- tag column 1 -->
                    <table style="margin-top:10px;margin-left:15px;" class="table table-fixed table-condensed table-striped" id="TableDocument" width="100%" cellspacing="0" role="grid" style="">
                        <thead id="theadsum" style="font-size:24px;">
                          <tr role="row">
                            ...
                            <th style='width: 11%;'><?php echo $array['code'][$language]; ?></th>
                            <th style='width: 12%;'><?php echo $array['item'][$language]; ?></th>
                            <th style='width: 15%;'><?php echo $array['category'][$language]; ?></th>
                            <th style='width: 12%;'><center><?php echo $array['department'][$language]; ?></center></th>
                            <th style='width: 12%;padding-right: 56px;'><center><?php echo $array['total'][$language]; ?></center></th>
                            ...
                            <th style='width: 8%;'><center><?php echo $array['disburse'][$language]; ?></center></th>
                          </tr>
                        </thead>
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="row">
                      ...
                      <button type="button"
                        style="font-size:18px;margin-left:30px; width:100px;font-family: 'THSarabunNew'"class="btn btn-primary" name="button" onclick="ShowItem();"><?php echo $array['search'][$language]; ?></button>
                    </div>
                  </div>
                  <div class="col-md-1">
                    <button type="button"
                      style="font-size:18px;margin-left:70px; width:100px;font-family: 'THSarabunNew'"class="btn btn-warning" name="button" onclick="getImport(1);"><?php echo $array['import'][$language]; ?></button>
                  </div>
                </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h4 class="modal-title"><?php echo $array['disburse'][$language]; ?></h4>
                  ...
                  <div class="modal-body">
                    <div class="row" style="margin-top:5px">
                      ...
                      <div style="width:220px;">
                        <input type="text" class="form-control" style="font-size:24px;width:220px;" disabled id="docdate" placeholder="<?php echo $array['docdate'][$language]; ?>">
                      </div>
                      <div style="margin-left:30px;width:120px;">
                        <label><?php echo $array['docno'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                        <input type="text" class="form-control" style="font-size:24px;width:220px;" disabled id="docno" placeholder="<?php echo $array['docno'][$language]; ?>">
                      </div>
                      <div style="margin-left:20px;width:100px;" hidden>
                        <label><?php echo $array['refdocno'][$language]; ?></label>
                      </div>
                      <div style="width:220px;" hidden>
                        <input class='form-control' style="font-size:20px;width:220px;height:40px;padding-top:6px;"id='RefDocNo' disabled placeholder="<?php echo $array['refdocno'][$language]; ?>"OnBlur='UpdateRefDocNo()'>
                      </div>
                      <div style="margin-left:30px;width:120px;">
                        <label><?php echo $array['requested'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                          <select style='font-size:24px;width:220px;' class="form-control" id="dis_department" onchange="getDepartment_sub2();">
                          </select>
                      </div>
                    ...
                    <div class="row" style="margin-top:5px;">
                      ...
                      <div style="width:220px;">
                        <input type="text" class="form-control" style="font-size:24px;width:220px;" id="recorder" disabled  placeholder="<?php echo $array['employee'][$language]; ?>">
                      </div>
                      <div style="margin-left:30px;width:120px;">
                        <label><?php echo $array['time'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                        <input type="text" class="form-control" style="font-size:24px;width:220px;" id="timerec" disabled placeholder="<?php echo $array['time'][$language]; ?>">
                      </div>
                      <div style="margin-left:30px;width:120px;">
                        <label><?php echo $array['department_sub'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                          <select style='font-size:24px;width:220px;' class="form-control" id="department_sub" >
                          </select>
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                      <div class="card-body" style="padding:0px;">
                        <table class="table table-fixed table-condensed table-striped" id="table_disburse"  cellspacing="0" role="grid" style="font-size:24px;font-family: 'THSarabunNew'">
                          <thead style="font-size:24px;">
                            <tr role="row">
                              <th style='width: 10%;'><?php echo $array['code'][$language]; ?></th>
                              <th style='width: 15%;'><?php echo $array['item'][$language]; ?></th>
                              <th style='width: 20%;'><?php echo $array['department'][$language]; ?></th>
                              <th style='width: 18%;'><?php echo $array['department_sub'][$language]; ?></th>
                              <th style='width: 12%;'><center><?php echo $array['numofpiece'][$language]; ?></center></th>
                              <th style='width: 25%;'><center><?php echo $array['disburse'][$language]; ?></center></th>
                            </tr>
                          </thead>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-success"onclick="CreateDocument()"><?php echo $array['save'][$language]; ?></button>
                  </div>
             ...
             <div class="modal" id="disburseModal2">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- <div class="row" style="margin-top:5px">
                      <div style="margin-left:20px;width:100px;padding-left:10px;">
                        <label><?php echo $array['docdate'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                        <input type="text" class="form-control" style="font-size:24px;width:220px;" disabled id="Docdate2" placeholder="<?php echo $array['docdate'][$language]; ?>">
                      </div>
                      <div style="margin-left:30px;width:120px;padding-left: 25px;">
                        <label><?php echo $array['docno'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                      ...
                      <div style="width:220px;" hidden>
                        <input class='form-control' style="font-size:20px;width:220px;height:40px;padding-top:6px;" id='RefDocNo2' disabled placeholder="<?php echo $array['refdocno'][$language]; ?>"OnBlur='UpdateRefDocNo()'>
                      </div>
                      
                    </div> -->
                    <!-- <div class="row" style="margin-top:5px;">
                      <div style="margin-left:20px;width:100px;padding-left: 35px;">
                        <label><?php echo $array['employee'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                        <input type="text" class="form-control" style="font-size:24px;width:220px;" id="Recorder2" disabled  placeholder="<?php echo $array['employee'][$language]; ?>">
                      </div>
                      <div style="margin-left:30px;width:120px;padding-left: 25px;">
                        <label><?php echo $array['time'][$language]; ?></label>
                      </div>
                    ...
                    <!-- <div class="row" style="margin-top:5px;">
                      <div style="margin-left:30px;width:90px;padding-left: 45px;">
                        <label><?php echo $array['requested'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                        <input class='form-control' style="font-size:20px;width:220px;height:40px;padding-top:6px;" class="form-control" id="dis_department2" disabled>
                      </div>
                      <div style="margin-left:30px;width:120px;padding-left: 50px;">
                        <label><?php echo $array['department_sub'][$language]; ?></label>
                      </div>
                      <div style="width:220px;">
                        <input class='form-control' style="font-size:20px;width:220px;height:40px;padding-top:6px;" class="form-control" id="department_sub2" disabled>
                      </div>
                    </div> -->
                    ...
                    <div class="row">
                      <div class="form-group row col-md-6">
                        <label class='col-md-4 text-right'><?php echo $array['requested'][$language]; ?></label>
                        <div class="col-md-8">
                          <input class='form-control' style="font-size:20px;width:220px;height:40px;padding-top:6px;" class="form-control" id="dis_department2" disabled>
                        </div>
                      </div>
                        ...
                        <table class="table table-fixed table-condensed table-striped" id="table_disburse2"  cellspacing="0" role="grid" style="font-size:24px;font-family: 'THSarabunNew'">
                          <thead style="font-size:24px;">
                            <tr role="row">
                              ...
                              <th style='width: 20%;'><?php echo $array['department'][$language]; ?></th>
                              <th style='width: 18%;'><?php echo $array['department_sub'][$language]; ?></th>
                              <th style='width: 37%;'><center><?php echo $array['getitem'][$language]; ?></center></th>
                            </tr>
                          </thead>
                          <tbody id="tbody1_disburse" class="nicescrolled" style="font-size:23px;height:100px;">
                          </tbody>
