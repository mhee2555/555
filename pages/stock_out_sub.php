...
<head>
  ...
  <script type="text/javascript">
    ...
    function ShowDocument(selecta) {
      ...
      var hpt = $('#hotpital2 option:selected').attr("value");
      var deptCode = $('#Dep2 option:selected').attr("value");
      var deptCode_sub = $('#department_sub2 option:selected').attr("value");
      if (typeof hpt == 'undefined') hpt = "1";
      if (typeof deptCode == 'undefined') deptCode = "1";
      if (typeof deptCode_sub == 'undefined') deptCode_sub = "1";
      var data = {
        'STATUS': 'ShowDocument',
    ...
    function senddata(data) {
      ...
      var URL = '../process/stock_out_sub.php';
      $.ajax({
        url: URL,
        dataType: 'text',
        cache: false,
        ...
        success: function (result) {
          ...
          if (temp["status"] == 'success') {
            if (temp["form"] == 'OnLoadPage') {
            ...
            } else if (temp["form"] == 'getDepartment_sub2') {
              $("#department_sub2").empty();
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                var Str = "<option value=" + temp[i]['DepSubCode'] + ">" + temp[i]['DepSubName'] + "</option>";
                $("#department_sub2").append(Str);
              }
              ...
              for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                ...
                $StrTr = "<tr id='tr" + temp[i]['DocNo'] + "'>" +
                  ...
                  "<td style='width: 12%;'>" + temp[i]['DocDate'] + "</td>" +
...
<body id="page-top">
  <input class='form-control' type="hidden"
    style="margin-left:-48px;margin-top:10px;font-size:16px;width:100px;height:30px;text-align:right;padding-top: 15px;"
    id='IsStatus'>
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="row" style="margin-top:20px;margin-bottom:5px;">
                  <div class="col-md-2">
                    <div class="row" style="font-size:24px;margin-left:2px;">
                      <select class="form-control" style='font-size:24px;' id="hotpital2" disabled>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="row" style="font-size:24px;margin-left:2px;">
                      <select class="form-control" style='font-size:24px;' id="Dep2" onchange="getDepartment_sub2();">
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="row" style="font-size:24px;margin-left:2px;">
                      <select class="form-control" style='font-size:24px;' id="department_sub2">
                      </select>
                    </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-12">
                    ...
                    <table style="margin-top:10px;" class="table table-fixed table-condensed table-striped"
                      ...
                      <thead id="theadsum" style="font-size:24px;">
                        <tr role="row">
                          <th style='width: 8%;'>&nbsp;</th>
                          <th style='width: 12%;'><?php echo $array['docdate'][$language]; ?></th>
